...
restaurant3 = Restaurant("Ichiban", "Japanese")
...
# Exercise 9-3
user1 = User("John", "Smith", 21, "PA", "jsmith@email.com")
user2 = User("Ava", "Kelly", 19, "NJ", "ava@email.com")
user3 = User("Ben", "Reed", 25, "NY", "ben@email.com")
...
# 9-5 Login Attempts
new_user = User("Mike", "Lowery", 30, "MD", "ml@example.com")
...
admin2 = Admin2("Kevin", "Hart", 40, "LA", "kh@example.com")
